...
func (m MarketDataSnapshotFullRefresh) GetInstrRegistry() (v string, err quickfix.MessageRejectError) {
...
func (m MarketDataSnapshotFullRefresh) GetTickSize() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m MarketDataSnapshotFullRefresh) GetPriceHighLimit() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m MarketDataSnapshotFullRefresh) GetPriceLowLimit() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m MarketDataSnapshotFullRefresh) GetInstrumentPricePrecision() (v int, err quickfix.MessageRejectError) {
...
func (m MarketDataSnapshotFullRefresh) GetMaxAmount() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m MarketDataSnapshotFullRefresh) GetTradingDeadline() (v int, err quickfix.MessageRejectError) {
...
func (m MarketDataSnapshotFullRefresh) GetSizeLowLimit() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m MarketDataSnapshotFullRefresh) GetSizeHighLimit() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m MarketDataSnapshotFullRefresh) GetInstrumentSizePrecision() (v int, err quickfix.MessageRejectError) {
...
func (m MarketDataSnapshotFullRefresh) GetQuoteSizeLowLimit() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m MarketDataSnapshotFullRefresh) GetQuoteSizeHighLimit() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m MarketDataSnapshotFullRefresh) GetRofexProps() (v enum.RofexProps, err quickfix.MessageRejectError) {
...
func (m NoMDEntries) SetAccount(v string) {
...
func (m NoMDEntries) SetDealingCapacity(v string) {
...
// SetTradeSide sets TradeSide, Tag 7201.
func (m NoMDEntries) SetTradeSide(v enum.TradeSide) {
	m.Set(field.NewTradeSide(v))
}
...
// SetMDEntrySizes sets MDEntrySizes, Tag 7202.
func (m NoMDEntries) SetMDEntrySizes(v string) {
	m.Set(field.NewMDEntrySizes(v))
}
...
func (m NoMDEntries) GetTradingSessionSubID() (v string, err quickfix.MessageRejectError) {
...
func (m NoMDEntries) GetAccount() (v string, err quickfix.MessageRejectError) {
...
func (m NoMDEntries) GetDealingCapacity() (v string, err quickfix.MessageRejectError) {
...
// GetTradeSide gets TradeSide, Tag 7201.
func (m NoMDEntries) GetTradeSide() (v enum.TradeSide, err quickfix.MessageRejectError) {
	var f field.TradeSideField
	if err = m.Get(&f); err == nil {
		v = f.Value()
	}
	return
...
// GetMDEntrySizes gets MDEntrySizes, Tag 7202.
func (m NoMDEntries) GetMDEntrySizes() (v string, err quickfix.MessageRejectError) {
	var f field.MDEntrySizesField
	if err = m.Get(&f); err == nil {
		v = f.Value()
	}
	return
...
func (m NoMDEntries) HasAccount() bool {
...
// HasTradeSide returns true if TradeSide is present, Tag 7201.
func (m NoMDEntries) HasTradeSide() bool {
	return m.Has(tag.TradeSide)
}
...
// HasMDEntrySizes returns true if MDEntrySizes is present, Tag 7202.
func (m NoMDEntries) HasMDEntrySizes() bool {
	return m.Has(tag.MDEntrySizes)
}
