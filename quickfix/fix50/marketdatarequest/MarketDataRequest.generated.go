...
// SetMarketDataType sets MarketDataType, Tag 7118.
func (m MarketDataRequest) SetMarketDataType(v enum.MarketDataType) {
	m.Set(field.NewMarketDataType(v))
}
...
// GetMarketDataType gets MarketDataType, Tag 7118.
func (m MarketDataRequest) GetMarketDataType() (v enum.MarketDataType, err quickfix.MessageRejectError) {
	var f field.MarketDataTypeField
	if err = m.Get(&f); err == nil {
		v = f.Value()
	}
	return
...
// HasMarketDataType returns true if MarketDataType is present, Tag 7118.
func (m MarketDataRequest) HasMarketDataType() bool {
	return m.Has(tag.MarketDataType)
}
...
func (m NoTradingSessions) GetTradingSessionSubID() (v string, err quickfix.MessageRejectError) {
