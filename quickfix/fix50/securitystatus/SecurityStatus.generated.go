...
// SetHaltReason sets HaltReason, Tag 327.
func (m SecurityStatus) SetHaltReason(v enum.HaltReason) {
	m.Set(field.NewHaltReason(v))
}
...
// GetHaltReason gets HaltReason, Tag 327.
func (m SecurityStatus) GetHaltReason() (v enum.HaltReason, err quickfix.MessageRejectError) {
	var f field.HaltReasonField
	if err = m.Get(&f); err == nil {
		v = f.Value()
	}
	return
...
func (m SecurityStatus) GetTradingSessionID() (v string, err quickfix.MessageRejectError) {
...
func (m SecurityStatus) GetInstrRegistry() (v string, err quickfix.MessageRejectError) {
...
func (m SecurityStatus) GetTradingSessionSubID() (v string, err quickfix.MessageRejectError) {
...
func (m SecurityStatus) GetTickSize() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m SecurityStatus) GetPriceHighLimit() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m SecurityStatus) GetPriceLowLimit() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m SecurityStatus) GetInstrumentPricePrecision() (v int, err quickfix.MessageRejectError) {
...
func (m SecurityStatus) GetMaxAmount() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m SecurityStatus) GetTradingDeadline() (v int, err quickfix.MessageRejectError) {
...
func (m SecurityStatus) GetSizeLowLimit() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m SecurityStatus) GetSizeHighLimit() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m SecurityStatus) GetInstrumentSizePrecision() (v int, err quickfix.MessageRejectError) {
...
func (m SecurityStatus) GetQuoteSizeLowLimit() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m SecurityStatus) GetQuoteSizeHighLimit() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m SecurityStatus) GetRofexProps() (v enum.RofexProps, err quickfix.MessageRejectError) {
...
// HasHaltReason returns true if HaltReason is present, Tag 327.
func (m SecurityStatus) HasHaltReason() bool {
	return m.Has(tag.HaltReason)
}
