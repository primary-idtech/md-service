package accountlistincremental
...
// AccountListIncremental is the fix50 AccountListIncremental type, MsgType = UALI.
type AccountListIncremental struct {
	fixt11.Header
	*quickfix.Body
	fixt11.Trailer
...
// FromMessage creates a AccountListIncremental from a quickfix.Message instance.
func FromMessage(m *quickfix.Message) AccountListIncremental {
	return AccountListIncremental{
...
func (m AccountListIncremental) ToMessage() *quickfix.Message {
	return m.Message
}

// New returns a AccountListIncremental initialized with the required fields for AccountListIncremental.
func New(accountrequestresult field.AccountRequestResultField) (m AccountListIncremental) {
	m.Message = quickfix.NewMessage()
	m.Header = fixt11.NewHeader(&m.Message.Header)
	m.Body = &m.Message.Body
	m.Trailer.Trailer = &m.Message.Trailer

	m.Header.Set(field.NewMsgType("UALI"))
...
type RouteOut func(msg AccountListIncremental, sessionID quickfix.SessionID) quickfix.MessageRejectError
...
func (m AccountListIncremental) SetText(v string) {
	m.Set(field.NewText(v))
}

// SetAccountRequestID sets AccountRequestID, Tag 7110.
func (m AccountListIncremental) SetAccountRequestID(v string) {
	m.Set(field.NewAccountRequestID(v))
}

// SetAccountRequestResult sets AccountRequestResult, Tag 7112.
func (m AccountListIncremental) SetAccountRequestResult(v enum.AccountRequestResult) {
	m.Set(field.NewAccountRequestResult(v))
}

// SetNoRelatedAcc sets NoRelatedAcc, Tag 7113.
func (m AccountListIncremental) SetNoRelatedAcc(f NoRelatedAccRepeatingGroup) {
	m.SetGroup(f)
}

// GetText gets Text, Tag 58.
func (m AccountListIncremental) GetText() (v string, err quickfix.MessageRejectError) {
...
func (m AccountListIncremental) GetAccountRequestID() (v string, err quickfix.MessageRejectError) {
...
func (m AccountListIncremental) GetAccountRequestResult() (v enum.AccountRequestResult, err quickfix.MessageRejectError) {
...
func (m AccountListIncremental) GetNoRelatedAcc() (NoRelatedAccRepeatingGroup, quickfix.MessageRejectError) {
