...
// AccountListRequestTypeField is a enum.AccountListRequestType field.
type AccountListRequestTypeField struct{ quickfix.FIXString }

// Tag returns tag.AccountListRequestType (7111).
func (f AccountListRequestTypeField) Tag() quickfix.Tag { return tag.AccountListRequestType }

func NewAccountListRequestType(val enum.AccountListRequestType) AccountListRequestTypeField {
	return AccountListRequestTypeField{quickfix.FIXString(val)}
}

func (f AccountListRequestTypeField) Value() enum.AccountListRequestType {
	return enum.AccountListRequestType(f.String())
}

// AccountNameField is a STRING field.
type AccountNameField struct{ quickfix.FIXString }

// Tag returns tag.AccountName (7114).
func (f AccountNameField) Tag() quickfix.Tag { return tag.AccountName }

// NewAccountName returns a new AccountNameField initialized with val.
func NewAccountName(val string) AccountNameField {
	return AccountNameField{quickfix.FIXString(val)}
}

func (f AccountNameField) Value() string { return f.String() }

// AccountRequestIDField is a STRING field.
type AccountRequestIDField struct{ quickfix.FIXString }

// Tag returns tag.AccountRequestID (7110).
func (f AccountRequestIDField) Tag() quickfix.Tag { return tag.AccountRequestID }

// NewAccountRequestID returns a new AccountRequestIDField initialized with val.
func NewAccountRequestID(val string) AccountRequestIDField {
	return AccountRequestIDField{quickfix.FIXString(val)}
}

func (f AccountRequestIDField) Value() string { return f.String() }

// AccountRequestResultField is a enum.AccountRequestResult field.
type AccountRequestResultField struct{ quickfix.FIXString }

// Tag returns tag.AccountRequestResult (7112).
func (f AccountRequestResultField) Tag() quickfix.Tag { return tag.AccountRequestResult }

func NewAccountRequestResult(val enum.AccountRequestResult) AccountRequestResultField {
	return AccountRequestResultField{quickfix.FIXString(val)}
}

func (f AccountRequestResultField) Value() enum.AccountRequestResult {
	return enum.AccountRequestResult(f.String())
}

// AccountRiskCheckField is a BOOLEAN field.
type AccountRiskCheckField struct{ quickfix.FIXBoolean }

// Tag returns tag.AccountRiskCheck (7125).
func (f AccountRiskCheckField) Tag() quickfix.Tag { return tag.AccountRiskCheck }

// NewAccountRiskCheck returns a new AccountRiskCheckField initialized with val.
func NewAccountRiskCheck(val bool) AccountRiskCheckField {
	return AccountRiskCheckField{quickfix.FIXBoolean(val)}
}

func (f AccountRiskCheckField) Value() bool { return f.Bool() }

// AccountStatusField is a BOOLEAN field.
type AccountStatusField struct{ quickfix.FIXBoolean }

// Tag returns tag.AccountStatus (7126).
func (f AccountStatusField) Tag() quickfix.Tag { return tag.AccountStatus }

// NewAccountStatus returns a new AccountStatusField initialized with val.
func NewAccountStatus(val bool) AccountStatusField {
	return AccountStatusField{quickfix.FIXBoolean(val)}
}

func (f AccountStatusField) Value() bool { return f.Bool() }
...
// BuySettlPriceField is a PRICE field.
type BuySettlPriceField struct{ quickfix.FIXDecimal }

// Tag returns tag.BuySettlPrice (7300).
func (f BuySettlPriceField) Tag() quickfix.Tag { return tag.BuySettlPrice }

// NewBuySettlPrice returns a new BuySettlPriceField initialized with val and scale.
func NewBuySettlPrice(val decimal.Decimal, scale int32) BuySettlPriceField {
	return BuySettlPriceField{quickfix.FIXDecimal{Decimal: val, Scale: scale}}
}

func (f BuySettlPriceField) Value() (val decimal.Decimal) { return f.Decimal }
...
// ContractPositionNumberField is a INT field.
type ContractPositionNumberField struct{ quickfix.FIXInt }

// Tag returns tag.ContractPositionNumber (9996).
func (f ContractPositionNumberField) Tag() quickfix.Tag { return tag.ContractPositionNumber }

// NewContractPositionNumber returns a new ContractPositionNumberField initialized with val.
func NewContractPositionNumber(val int) ContractPositionNumberField {
	return ContractPositionNumberField{quickfix.FIXInt(val)}
}

func (f ContractPositionNumberField) Value() int { return f.Int() }

// ContractSettlMonthField is a STRING field.
...
// DDJJAcceptanceField is a enum.DDJJAcceptance field.
type DDJJAcceptanceField struct{ quickfix.FIXString }

// Tag returns tag.DDJJAcceptance (7400).
func (f DDJJAcceptanceField) Tag() quickfix.Tag { return tag.DDJJAcceptance }

func NewDDJJAcceptance(val enum.DDJJAcceptance) DDJJAcceptanceField {
	return DDJJAcceptanceField{quickfix.FIXString(val)}
}

func (f DDJJAcceptanceField) Value() enum.DDJJAcceptance { return enum.DDJJAcceptance(f.String()) }
...
func (f DealingCapacityField) Value() string { return f.String() }
...
func (f InstrRegistryField) Value() string { return f.String() }
...
// InstrumentPricePrecisionField is a INT field.
type InstrumentPricePrecisionField struct{ quickfix.FIXInt }

// Tag returns tag.InstrumentPricePrecision (5514).
func (f InstrumentPricePrecisionField) Tag() quickfix.Tag { return tag.InstrumentPricePrecision }

// NewInstrumentPricePrecision returns a new InstrumentPricePrecisionField initialized with val.
func NewInstrumentPricePrecision(val int) InstrumentPricePrecisionField {
	return InstrumentPricePrecisionField{quickfix.FIXInt(val)}
}

func (f InstrumentPricePrecisionField) Value() int { return f.Int() }

// InstrumentSizePrecisionField is a INT field.
type InstrumentSizePrecisionField struct{ quickfix.FIXInt }

// Tag returns tag.InstrumentSizePrecision (7117).
func (f InstrumentSizePrecisionField) Tag() quickfix.Tag { return tag.InstrumentSizePrecision }

// NewInstrumentSizePrecision returns a new InstrumentSizePrecisionField initialized with val.
func NewInstrumentSizePrecision(val int) InstrumentSizePrecisionField {
	return InstrumentSizePrecisionField{quickfix.FIXInt(val)}
}

func (f InstrumentSizePrecisionField) Value() int { return f.Int() }
...
// LegContractSettlMonthField is a STRING field.
...
// LegMaturityMonthYearField is a STRING field.
...
// MDElementNameField is a enum.MDElementName field.
type MDElementNameField struct{ quickfix.FIXString }

// Tag returns tag.MDElementName (5450).
func (f MDElementNameField) Tag() quickfix.Tag { return tag.MDElementName }

func NewMDElementName(val enum.MDElementName) MDElementNameField {
	return MDElementNameField{quickfix.FIXString(val)}
}

func (f MDElementNameField) Value() enum.MDElementName { return enum.MDElementName(f.String()) }
...
// MDEntrySizesField is a STRING field.
type MDEntrySizesField struct{ quickfix.FIXString }

// Tag returns tag.MDEntrySizes (7202).
func (f MDEntrySizesField) Tag() quickfix.Tag { return tag.MDEntrySizes }

// NewMDEntrySizes returns a new MDEntrySizesField initialized with val.
func NewMDEntrySizes(val string) MDEntrySizesField {
	return MDEntrySizesField{quickfix.FIXString(val)}
}

func (f MDEntrySizesField) Value() string { return f.String() }
...
// MarketAliasNameField is a STRING field.
type MarketAliasNameField struct{ quickfix.FIXString }

// Tag returns tag.MarketAliasName (7123).
func (f MarketAliasNameField) Tag() quickfix.Tag { return tag.MarketAliasName }

// NewMarketAliasName returns a new MarketAliasNameField initialized with val.
func NewMarketAliasName(val string) MarketAliasNameField {
	return MarketAliasNameField{quickfix.FIXString(val)}
}

func (f MarketAliasNameField) Value() string { return f.String() }

// MarketDataTypeField is a enum.MarketDataType field.
type MarketDataTypeField struct{ quickfix.FIXString }

// Tag returns tag.MarketDataType (7118).
func (f MarketDataTypeField) Tag() quickfix.Tag { return tag.MarketDataType }

func NewMarketDataType(val enum.MarketDataType) MarketDataTypeField {
	return MarketDataTypeField{quickfix.FIXString(val)}
}

func (f MarketDataTypeField) Value() enum.MarketDataType { return enum.MarketDataType(f.String()) }
...
// MarketIDField is a STRING field.
...
// MaturityDayField is a INT field.
...
// MaturityMonthYearField is a STRING field.
...
// MaxAmountField is a AMT field.
type MaxAmountField struct{ quickfix.FIXDecimal }

// Tag returns tag.MaxAmount (5516).
func (f MaxAmountField) Tag() quickfix.Tag { return tag.MaxAmount }

// NewMaxAmount returns a new MaxAmountField initialized with val and scale.
func NewMaxAmount(val decimal.Decimal, scale int32) MaxAmountField {
	return MaxAmountField{quickfix.FIXDecimal{Decimal: val, Scale: scale}}
}

func (f MaxAmountField) Value() (val decimal.Decimal) { return f.Decimal }
...
// MaxLotSizeField is a QTY field.
type MaxLotSizeField struct{ quickfix.FIXDecimal }

// Tag returns tag.MaxLotSize (5515).
func (f MaxLotSizeField) Tag() quickfix.Tag { return tag.MaxLotSize }

// NewMaxLotSize returns a new MaxLotSizeField initialized with val and scale.
func NewMaxLotSize(val decimal.Decimal, scale int32) MaxLotSizeField {
	return MaxLotSizeField{quickfix.FIXDecimal{Decimal: val, Scale: scale}}
}

func (f MaxLotSizeField) Value() (val decimal.Decimal) { return f.Decimal }
...
// NestedUserDataNameField is a STRING field.
type NestedUserDataNameField struct{ quickfix.FIXString }

// Tag returns tag.NestedUserDataName (9001).
func (f NestedUserDataNameField) Tag() quickfix.Tag { return tag.NestedUserDataName }

// NewNestedUserDataName returns a new NestedUserDataNameField initialized with val.
func NewNestedUserDataName(val string) NestedUserDataNameField {
	return NestedUserDataNameField{quickfix.FIXString(val)}
}

func (f NestedUserDataNameField) Value() string { return f.String() }

// NestedUserDataValueField is a STRING field.
type NestedUserDataValueField struct{ quickfix.FIXString }

// Tag returns tag.NestedUserDataValue (9002).
func (f NestedUserDataValueField) Tag() quickfix.Tag { return tag.NestedUserDataValue }

// NewNestedUserDataValue returns a new NestedUserDataValueField initialized with val.
func NewNestedUserDataValue(val string) NestedUserDataValueField {
	return NestedUserDataValueField{quickfix.FIXString(val)}
}

func (f NestedUserDataValueField) Value() string { return f.String() }
...
// NoMarketAliasField is a NUMINGROUP field.
type NoMarketAliasField struct{ quickfix.FIXInt }

// Tag returns tag.NoMarketAlias (7122).
func (f NoMarketAliasField) Tag() quickfix.Tag { return tag.NoMarketAlias }

// NewNoMarketAlias returns a new NoMarketAliasField initialized with val.
func NewNoMarketAlias(val int) NoMarketAliasField {
	return NoMarketAliasField{quickfix.FIXInt(val)}
}

func (f NoMarketAliasField) Value() int { return f.Int() }
...
// NoNestedUserDataField is a INT field.
type NoNestedUserDataField struct{ quickfix.FIXInt }

// Tag returns tag.NoNestedUserData (9000).
func (f NoNestedUserDataField) Tag() quickfix.Tag { return tag.NoNestedUserData }

// NewNoNestedUserData returns a new NoNestedUserDataField initialized with val.
func NewNoNestedUserData(val int) NoNestedUserDataField {
	return NoNestedUserDataField{quickfix.FIXInt(val)}
}

func (f NoNestedUserDataField) Value() int { return f.Int() }
...
// NoRelatedAccField is a NUMINGROUP field.
type NoRelatedAccField struct{ quickfix.FIXInt }

// Tag returns tag.NoRelatedAcc (7113).
func (f NoRelatedAccField) Tag() quickfix.Tag { return tag.NoRelatedAcc }

// NewNoRelatedAcc returns a new NoRelatedAccField initialized with val.
func NewNoRelatedAcc(val int) NoRelatedAccField {
	return NoRelatedAccField{quickfix.FIXInt(val)}
}

func (f NoRelatedAccField) Value() int { return f.Int() }
...
// PersonIDField is a QTY field.
type PersonIDField struct{ quickfix.FIXDecimal }

// Tag returns tag.PersonID (7121).
func (f PersonIDField) Tag() quickfix.Tag { return tag.PersonID }

// NewPersonID returns a new PersonIDField initialized with val and scale.
func NewPersonID(val decimal.Decimal, scale int32) PersonIDField {
	return PersonIDField{quickfix.FIXDecimal{Decimal: val, Scale: scale}}
}

func (f PersonIDField) Value() (val decimal.Decimal) { return f.Decimal }
...
// PriceHighLimitField is a QTY field.
type PriceHighLimitField struct{ quickfix.FIXDecimal }

// Tag returns tag.PriceHighLimit (5024).
func (f PriceHighLimitField) Tag() quickfix.Tag { return tag.PriceHighLimit }

// NewPriceHighLimit returns a new PriceHighLimitField initialized with val and scale.
func NewPriceHighLimit(val decimal.Decimal, scale int32) PriceHighLimitField {
	return PriceHighLimitField{quickfix.FIXDecimal{Decimal: val, Scale: scale}}
}

func (f PriceHighLimitField) Value() (val decimal.Decimal) { return f.Decimal }
...
// PriceLowLimitField is a QTY field.
type PriceLowLimitField struct{ quickfix.FIXDecimal }

// Tag returns tag.PriceLowLimit (5025).
func (f PriceLowLimitField) Tag() quickfix.Tag { return tag.PriceLowLimit }

// NewPriceLowLimit returns a new PriceLowLimitField initialized with val and scale.
func NewPriceLowLimit(val decimal.Decimal, scale int32) PriceLowLimitField {
	return PriceLowLimitField{quickfix.FIXDecimal{Decimal: val, Scale: scale}}
}

func (f PriceLowLimitField) Value() (val decimal.Decimal) { return f.Decimal }
...
// QuoteReqServerIDField is a STRING field.
type QuoteReqServerIDField struct{ quickfix.FIXString }

// Tag returns tag.QuoteReqServerID (7124).
func (f QuoteReqServerIDField) Tag() quickfix.Tag { return tag.QuoteReqServerID }

// NewQuoteReqServerID returns a new QuoteReqServerIDField initialized with val.
func NewQuoteReqServerID(val string) QuoteReqServerIDField {
	return QuoteReqServerIDField{quickfix.FIXString(val)}
}

func (f QuoteReqServerIDField) Value() string { return f.String() }
...
// QuoteSizeHighLimitField is a QTY field.
type QuoteSizeHighLimitField struct{ quickfix.FIXDecimal }

// Tag returns tag.QuoteSizeHighLimit (7120).
func (f QuoteSizeHighLimitField) Tag() quickfix.Tag { return tag.QuoteSizeHighLimit }

// NewQuoteSizeHighLimit returns a new QuoteSizeHighLimitField initialized with val and scale.
func NewQuoteSizeHighLimit(val decimal.Decimal, scale int32) QuoteSizeHighLimitField {
	return QuoteSizeHighLimitField{quickfix.FIXDecimal{Decimal: val, Scale: scale}}
}

func (f QuoteSizeHighLimitField) Value() (val decimal.Decimal) { return f.Decimal }

// QuoteSizeLowLimitField is a QTY field.
type QuoteSizeLowLimitField struct{ quickfix.FIXDecimal }

// Tag returns tag.QuoteSizeLowLimit (7119).
func (f QuoteSizeLowLimitField) Tag() quickfix.Tag { return tag.QuoteSizeLowLimit }

// NewQuoteSizeLowLimit returns a new QuoteSizeLowLimitField initialized with val and scale.
func NewQuoteSizeLowLimit(val decimal.Decimal, scale int32) QuoteSizeLowLimitField {
	return QuoteSizeLowLimitField{quickfix.FIXDecimal{Decimal: val, Scale: scale}}
}

func (f QuoteSizeLowLimitField) Value() (val decimal.Decimal) { return f.Decimal }
...
// RofexPropsField is a enum.RofexProps field.
type RofexPropsField struct{ quickfix.FIXString }

// Tag returns tag.RofexProps (7200).
func (f RofexPropsField) Tag() quickfix.Tag { return tag.RofexProps }

func NewRofexProps(val enum.RofexProps) RofexPropsField {
	return RofexPropsField{quickfix.FIXString(val)}
}

func (f RofexPropsField) Value() enum.RofexProps { return enum.RofexProps(f.String()) }
...
// SellSettlPriceField is a PRICE field.
type SellSettlPriceField struct{ quickfix.FIXDecimal }

// Tag returns tag.SellSettlPrice (7301).
func (f SellSettlPriceField) Tag() quickfix.Tag { return tag.SellSettlPrice }

// NewSellSettlPrice returns a new SellSettlPriceField initialized with val and scale.
func NewSellSettlPrice(val decimal.Decimal, scale int32) SellSettlPriceField {
	return SellSettlPriceField{quickfix.FIXDecimal{Decimal: val, Scale: scale}}
}

func (f SellSettlPriceField) Value() (val decimal.Decimal) { return f.Decimal }
...
// SimulatedTimeField is a UTCTIMESTAMP field.
type SimulatedTimeField struct{ quickfix.FIXUTCTimestamp }

// Tag returns tag.SimulatedTime (8000).
func (f SimulatedTimeField) Tag() quickfix.Tag { return tag.SimulatedTime }

// NewSimulatedTime returns a new SimulatedTimeField initialized with val.
func NewSimulatedTime(val time.Time) SimulatedTimeField {
	return NewSimulatedTimeWithPrecision(val, quickfix.Millis)
}

// NewSimulatedTimeNoMillis returns a new SimulatedTimeField initialized with val without millisecs.
func NewSimulatedTimeNoMillis(val time.Time) SimulatedTimeField {
	return NewSimulatedTimeWithPrecision(val, quickfix.Seconds)
}

// NewSimulatedTimeWithPrecision returns a new SimulatedTimeField initialized with val of specified precision.
func NewSimulatedTimeWithPrecision(val time.Time, precision quickfix.TimestampPrecision) SimulatedTimeField {
	return SimulatedTimeField{quickfix.FIXUTCTimestamp{Time: val, Precision: precision}}
}

func (f SimulatedTimeField) Value() time.Time { return f.Time }

// SizeHighLimitField is a QTY field.
type SizeHighLimitField struct{ quickfix.FIXDecimal }

// Tag returns tag.SizeHighLimit (7116).
func (f SizeHighLimitField) Tag() quickfix.Tag { return tag.SizeHighLimit }

// NewSizeHighLimit returns a new SizeHighLimitField initialized with val and scale.
func NewSizeHighLimit(val decimal.Decimal, scale int32) SizeHighLimitField {
	return SizeHighLimitField{quickfix.FIXDecimal{Decimal: val, Scale: scale}}
}

func (f SizeHighLimitField) Value() (val decimal.Decimal) { return f.Decimal }

// SizeLowLimitField is a QTY field.
type SizeLowLimitField struct{ quickfix.FIXDecimal }

// Tag returns tag.SizeLowLimit (7115).
func (f SizeLowLimitField) Tag() quickfix.Tag { return tag.SizeLowLimit }

// NewSizeLowLimit returns a new SizeLowLimitField initialized with val and scale.
func NewSizeLowLimit(val decimal.Decimal, scale int32) SizeLowLimitField {
	return SizeLowLimitField{quickfix.FIXDecimal{Decimal: val, Scale: scale}}
}

func (f SizeLowLimitField) Value() (val decimal.Decimal) { return f.Decimal }
...
// SpotValueDateForNDFField is a LOCALMKTDATE field.
type SpotValueDateForNDFField struct{ quickfix.FIXString }

// Tag returns tag.SpotValueDateForNDF (9995).
func (f SpotValueDateForNDFField) Tag() quickfix.Tag { return tag.SpotValueDateForNDF }

// NewSpotValueDateForNDF returns a new SpotValueDateForNDFField initialized with val.
func NewSpotValueDateForNDF(val string) SpotValueDateForNDFField {
	return SpotValueDateForNDFField{quickfix.FIXString(val)}
}

func (f SpotValueDateForNDFField) Value() string { return f.String() }
...
// TradeSideField is a enum.TradeSide field.
type TradeSideField struct{ quickfix.FIXString }

// Tag returns tag.TradeSide (7201).
func (f TradeSideField) Tag() quickfix.Tag { return tag.TradeSide }

func NewTradeSide(val enum.TradeSide) TradeSideField {
	return TradeSideField{quickfix.FIXString(val)}
}

func (f TradeSideField) Value() enum.TradeSide { return enum.TradeSide(f.String()) }
...
// TradingDeadlineField is a INT field.
type TradingDeadlineField struct{ quickfix.FIXInt }

// Tag returns tag.TradingDeadline (5517).
func (f TradingDeadlineField) Tag() quickfix.Tag { return tag.TradingDeadline }

// NewTradingDeadline returns a new TradingDeadlineField initialized with val.
func NewTradingDeadline(val int) TradingDeadlineField {
	return TradingDeadlineField{quickfix.FIXInt(val)}
}

func (f TradingDeadlineField) Value() int { return f.Int() }
...
func (f TradingSessionSubIDField) Value() string { return f.String() }
...
// UnderlyingMaturityDayField is a INT field.
...
// UnderlyingMaturityMonthYearField is a STRING field.
